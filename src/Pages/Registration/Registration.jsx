...
const Registration = () => {
    ...
    return (
       <div>
        <Navbar></Navbar>
         <div className="w-80 md:w-96 lg:w-[800px] mx-auto bg-white flex items-center relative overflow-hidden shadow-xl mt-6">
            {/* register form  */}
            ...
            <form className={`p-8 w-full mr-0 ml-auto duration-500 ${register ? 'lg:translate-x-full hidden lg:block' : ''}`}>
                ...
                <hr />
                <button type="button" className="py-2 px-5 mb-4 mt-8 mx-auto block shadow-lg border rounded-md border-black"><FcGoogle />Continue with Google</button>
            </form>
        </div>
       </div>
    );
